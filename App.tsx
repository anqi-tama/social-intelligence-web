  ...
  return (
    ...
    >
      ...
      <div className="bg-gradient-to-br from-[#161618] to-[#0c0c0e] p-8 rounded-3xl border border-[#252527] space-y-4">
        ...
        <button onClick={() => navigateTo('retail-blog')} className="text-red-400 text-xs font-black uppercase flex items-center gap-2 hover:text-red-300 transition-colors">READ MORE <ChevronRight className="w-3 h-3" /></button>
      </div>
    </div>
  );
};
    ...
    <div className="min-h-screen bg-[#070709] text-white selection:bg-red-500 selection:text-white font-['Inter']">
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 bg-[#070709] z-[100] p-12 flex flex-col gap-10 animate-in fade-in duration-300">
          ...
          <button className="mt-auto bg-red-600 py-6 rounded-3xl font-black text-xl font-heading">Book Demo</button>
        </div>
      )}
        ...
        <main className="animate-in fade-in duration-1000">
          <section className="pt-16 pb-32 px-6 relative overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto text-center space-y-12">
              <h1 className="text-5xl md:text-7xl font-black leading-tight tracking-tighter gradient-text font-heading">
          ...
          <section className="py-32 relative overflow-hidden border-t border-[#1b1b1d]">
            <div className="max-w-7xl mx-auto px-6 mb-24">
              <h2 className="text-5xl md:text-7xl font-black text-center text-white tracking-tighter font-heading">Reputation Intelligence at Scale</h2>
            </div>
            ...
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24 items-center">
              <div className="space-y-10">
                <div className="space-y-4 text-left">
                  ...
                  <h2 className="text-5xl font-black text-white font-heading">Access Customer Insight</h2>
              ...
              <div className="relative text-left">
                ...
                <div className="relative bg-[#0c0c0e] border border-white/5 p-12 rounded-[3rem] shadow-2xl">
                   <div className="flex items-center gap-3 mb-8">
                     ...
                     <h3 className="text-2xl font-bold font-heading">AI Power Suggestion</h3>
                   </div>
                   <div className="space-y-4">
                     {[
          ...
          <section className="py-32 px-6 border-t border-[#1b1b1d]">
            <div className="max-w-7xl mx-auto space-y-20">
              <div className="text-center space-y-4">
                <h2 className="text-5xl font-black font-heading">Powerful Features</h2>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="bg-white/5 border border-white/10 p-16 md:p-24 rounded-[4rem] text-center space-y-12 relative overflow-hidden">
                ...
                <div className="space-y-6 relative z-10">
                  <h2 className="text-5xl md:text-7xl font-black font-heading">Analytics at Scale</h2>
          ...
          <section className="py-32 px-6 border-t border-[#1b1b1d]">
            <div className="max-w-4xl mx-auto space-y-16">
              <h2 className="text-5xl font-black text-center font-heading">Frequently Asked Questions</h2>
              <div className="space-y-4">
                {FAQS.map((faq, i) => (
                  <div key={i} className="border-b border-[#1b1b1d] text-left">
                    ...
                    >
                      <span className={`text-lg font-bold transition-colors font-heading ${activeFaq === i ? 'text-red-400' : 'text-white'}`}>{faq.q}</span>
          ...
          <section className="pt-16 pb-32 px-6">
            <div className="max-w-7xl mx-auto space-y-24">
               <div className="text-center space-y-6">
                  <h1 className="text-6xl font-black font-heading">Social Listening Trend <br/>Across Industries</h1>
          ...
          <section className="pt-16 pb-32 px-6">
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24 text-left">
              ...
              <form className="bg-[#0c0c0e] border border-[#1b1b1d] p-12 rounded-[3rem] space-y-6">
                ...
                <button className="w-full py-6 bg-white text-black rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-red-600 hover:text-white transition-all font-heading">Send Inquiry</button>
              </form>
            </div>
          </section>
        </main>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="md:col-span-2 space-y-8">
            ...
            <div className="flex gap-6">
              <a href="https://www.instagram.com/thereadlineid?igsh=eTY2enJjcXdhamUz" target="_blank" rel="noopener noreferrer" className="text-[#6a6a6b] hover:text-white transition-colors">
                <Instagram size={20} />
              </a>
              <a href="https://x.com/thereadlineid" target="_blank" rel="noopener noreferrer" className="text-[#6a6a6b] hover:text-white transition-colors">
                <Twitter size={20} />
              </a>
              <a href="https://www.linkedin.com/showcase/read-line-id/posts/?feedView=all" target="_blank" rel="noopener noreferrer" className="text-[#6a6a6b] hover:text-white transition-colors">
                <Linkedin size={20} />
              </a>
            </div>
          </div>
          <div className="space-y-6 text-left">
            <h5 className="text-white font-bold text-xs uppercase tracking-[0.2em] font-heading">COMPANY</h5>
            <ul className="space-y-4 text-sm text-[#6a6a6b]">
              <li><button onClick={() => navigateTo('home')} className="hover:text-white transition-colors">About Us</button></li>
              <li><button onClick={() => navigateTo('retail-blog')} className="hover:text-white transition-colors">Case Studies</button></li>
              <li><button className="hover:text-white transition-colors">Careers</button></li>
              <li><button onClick={() => navigateTo('contact')} className="hover:text-white transition-colors">Contact</button></li>
            </ul>
          </div>
          <div className="space-y-6 text-left">
            <h5 className="text-white font-bold text-xs uppercase tracking-[0.2em] font-heading">OFFICE INFO</h5>
            <div className="space-y-4 text-sm text-[#6a6a6b]">
              ...
              <button className="block hover:text-white transition-colors text-left">WhatsApp Us</button>
            </div>
          </div>
        </div>
      </footer>
